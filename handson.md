...
```
다음 주에 '네이버'와 협업 미팅이 잡혔어.
미팅 전에 이 회사 빠르게 파악하게 정리해줘.
```

> 💡 네이버 대신 **미팅할 법한 상장사** 아무거나 — 카카오·SK하이닉스·크래프톤·현대차·현대건설 등. **정식 회사명**을 써야 결과가 나옵니다(비상장·외국계는 공식 공시가 없어 조회 불가).

**📋 이렇게 나오면 성공이에요** *(호출 시점에 따라 내용은 달라집니다)*

> ### 네이버(NAVER) — 미팅 전 브리프
> **한 줄 소개** — 경기 성남 분당 소재 국내 1위 인터넷 플랫폼(검색·커머스·핀테크·클라우드). 대표 최수연 / 업종: 포털·인터넷 서비스 / 설립 1999.
>
> **최근 공시 TOP 5**
> | 날짜 | 제목 | 링크 |
> |---|---|---|
> | 2026-06-04 | 주요사항보고서(자기주식 취득 결정) | [DART](https://dart.fss.or.kr/...) |
> | 2026-05-13 | 분기보고서 (1분기) | [DART](https://dart.fss.or.kr/...) |
> | 2026-04-24 | 단일판매·공급계약(클라우드) 체결 | [DART](https://dart.fss.or.kr/...) |
>
> **위험도 점수 2.5/10 🟡 LOW** — 자기주식 취득·정기보고 중심, 특이 위험 신호 없음.
>
> **미팅에서 확인할 질문**
> - 클라우드·AI 사업 확장이 우리 협업 범위와 어떻게 맞물리는지?
> - 최근 자기주식 취득이 주주환원·투자 우선순위에 주는 시그널은?
